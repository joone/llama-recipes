  ...
  gr.Interface(
    ...
    inputs=[
        gr.components.Textbox(
            lines=2,
            label="Instruction",
            placeholder="Translate the input to DQL queries:",
        ),
    ...
    title="Llama2 Test. Internal use only",
    description="Implemented based on https://github.com/facebookresearch/llama-recipes, <br>examples: people who majored in Sociology employed in the city of San Antonio or Seattle",
